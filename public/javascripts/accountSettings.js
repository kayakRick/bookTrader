...
export default class AccountSettings extends React.Component {
    constructor(props) {
        ...
        this.accountSettingsURL = getBaseUrl() + "accountSettings";
        this.getSettingsURL = getBaseUrl() + "settings";
        this.httpRequest;
                ...
                <form className="form-horizontal">
                    <div className={"form-group " +  userIdClass}>
                        ...
                        <div className="col-sm-10">
                                <input type="text" disabled className="form-control" id="userId"
                                    placeholder="Enter User Id"
                                    value={this.state.userId}></input>
                        </div>
                    </div>
